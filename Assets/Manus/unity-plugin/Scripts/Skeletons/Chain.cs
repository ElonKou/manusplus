...
namespace Manus.Skeletons
{
	...
	public class Chain
	{
		...
		public CoreSDK.ChainSettings settings = CoreSDK.ChainSettings.Default();
		...
		public CoreSDK.ChainSetup ToChainSetup()
		{
			return new CoreSDK.ChainSetup
			{
				id = id,
				type = type,
				dataType = appliedDataType,
				dataIndex = dataIndex,
				side = dataSide,
				nodeIdCount = (uint)nodeIds.Count,
